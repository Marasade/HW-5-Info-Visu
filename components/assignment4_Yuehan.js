...
const Charts = () => {
    ...
    // Q1.5: Lifted state to link points and bars
    const [selectedStation, setSelectedStation] = React.useState(null);

    // Q1.6: Tooltip position hooks
    ...
    // Q1.2: xScaleBar uses scaleBand over station names; yScaleBar maps start counts to bar height
    ...
    // Get the selected data point for the tooltip
    const selectedPoint = data.find(d => d.station === selectedStation) || null;
    ...
    return (
        <Container>
            ...
            {/* Q1.6: Tooltip rendered outside SVG as a div */}
            <Tooltip d={selectedPoint} x={tooltipX} y={tooltipY} />
        </Container>
    )
}
